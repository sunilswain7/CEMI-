...
exports.DotPaymentIntent = void 0;
...
const dotProxy_1 = require("./dotProxy");
exports.DotPaymentIntent = t.intersection([
    paymentIntent_1.PaymentIntent,
    dotAccountBaseBuildOptions_1.DotAccountBaseBuildOptions,
    t.type({
        proxy: dotProxy_1.DotProxy,
        owner: utils_1.optionalString,
    }),
]);
//# sourceMappingURL=dotPaymentIntent.js.map