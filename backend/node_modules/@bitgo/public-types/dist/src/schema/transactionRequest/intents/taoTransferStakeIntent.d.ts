...
export declare const TaoTransferStakeIntent: t.IntersectionC<[t.IntersectionC<[t.IntersectionC<[t.TypeC<{
    intentType: t.KeyofC<{
...
export type TaoTransferStakeIntent = t.TypeOf<typeof TaoTransferStakeIntent>;
