...
import { TransactionExplanation as BaseTransactionExplanation, Recipient, SolInstruction, SolVersionedInstruction } from '@bitgo/sdk-core';
...
export type InstructionParams = Nonce | Memo | WalletInit | SetComputeUnitLimit | SetPriorityFee | Transfer | StakingActivate | StakingDeactivate | StakingWithdraw | AtaInit | AtaClose | TokenTransfer | StakingAuthorize | StakingDelegate | MintTo | Burn | Approve | CustomInstruction | VersionedCustomInstruction;
...
export type ValidInstructionTypes = SystemInstructionType | StakeInstructionType | StakePoolInstructionType | 'Memo' | 'InitializeAssociatedTokenAccount' | 'CloseAssociatedTokenAccount' | DecodedCloseAccountInstruction | 'TokenTransfer' | 'SetComputeUnitLimit' | 'SetPriorityFee' | 'MintTo' | 'Burn' | 'Approve' | 'CustomInstruction';
