...
export type AdditionalHeadersCallback = (method: RequestMethods, url: string, data?: string) => Array<{
    key: string;
    value: string;
}>;
export { AuthVersion, CalculateHmacSubjectOptions, CalculateRequestHeadersOptions, CalculateRequestHmacOptions, RequestHeaders, supportedRequestMethods, VerifyResponseInfo, VerifyResponseOptions, } from '@bitgo/sdk-hmac';
export interface BitGoAPIOptions {
    accessToken?: string;
    authVersion?: 2 | 3;
    clientConstants?: Record<string, any> | {
