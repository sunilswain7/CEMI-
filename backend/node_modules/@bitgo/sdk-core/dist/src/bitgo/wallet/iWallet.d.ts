...
import { IBaseCoin, Message, SignedMessage, SignedTransaction, TransactionParams, TransactionPrebuild, VerificationOptions, TypedData, NFTTransferOptions } from '../baseCoin';
...
export type SendNFTOptions = Omit<SendManyOptions, 'recipients' | 'enableTokens' | 'tokenName' | 'txFormat' | 'receiveAddress'>;
...
export interface IWallet {
    ...
    buildErc20TokenApproval(tokenName: string, walletPassphrase?: string): Promise<BuildTokenApprovalResponse | SubmitTransactionResponse>;
}
export {};
