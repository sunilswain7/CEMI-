 ...
 * @deprecated
 */
export declare function setNetwork(network: V1Network): void;
/**
 * Get the global Bitcoin network. Used for v1 only.
 *
 * @deprecated
 */
export declare function getNetwork(): V1Network;
/**
 ...
 */
export declare function validateParams(params: object, expectedParams: string[], optionalParams?: string[], optionalCallback?: <R>(err: Error, res: R) => void): boolean;
