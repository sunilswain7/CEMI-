...
export declare function serializeSignature(signature: Signature): SerializedSignature;
export declare function serializeSignatures(signatures: Signature[]): SerializedSignature[];
export declare function deserializeSignature(serialized: SerializedSignature): Signature;
export declare function deserializeSignatures(serialized?: SerializedSignature[]): Signature[];
