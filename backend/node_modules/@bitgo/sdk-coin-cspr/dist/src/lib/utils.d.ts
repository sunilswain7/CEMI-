...
import { DefaultKeys, TransactionType } from '@bitgo/sdk-core';
 ...
 * @returns {boolean} - the validation result
 */
export declare function isValidTransferId(id: number | string): boolean;
/**
 ...
 */
export declare function getTransferId(transferTx: DeployUtil.ExecutableDeployItem): string | undefined;
/**
