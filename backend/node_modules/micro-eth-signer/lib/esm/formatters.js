export function parseDecimal(s, precision) {
    let neg = false;
    if (s.startsWith('-')) {
        neg = true;
        s = s.slice(1);
...
export function formatDecimal(n, precision) {
...
export function perCentDecimal(precision, price) {
    const fiatPrec = 18;
    //x * price = 0.01
 ...
 */
export function roundDecimal(n, roundPrecision, precision, price) {
    if (price && precision) {
