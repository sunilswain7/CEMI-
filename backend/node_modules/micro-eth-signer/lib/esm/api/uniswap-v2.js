...
export const INIT_CODE_HASH = hex.decode('96e8ac4277198ff8b6f785478aa9a39f403cb768dd02cbee326c3e7da348845f');
const PAIR_CONTRACT = [
    {
        type: 'function',
        name: 'getReserves',
...
export function create2(from, salt, initCodeHash) {
    return abi.add0x(hex.encode(keccak_256(P.concatBytes(new Uint8Array([255]), from, salt, initCodeHash)).slice(12)));
}
...
export async function reserves(net, a, b) {
...
export async function bestPath(net, tokenA, tokenB, amountIn, amountOut) {
