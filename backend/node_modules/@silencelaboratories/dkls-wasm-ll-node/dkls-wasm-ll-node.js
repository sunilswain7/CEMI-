...
const SignSessionOTVariantFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_signsessionotvariant_free(ptr >>> 0));
/**
*/
class SignSessionOTVariant {

    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(SignSessionOTVariant.prototype);
        obj.__wbg_ptr = ptr;
        SignSessionOTVariantFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        SignSessionOTVariantFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_signsessionotvariant_free(ptr);
    }
    /**
    * Create a new session.
    * @param {Keyshare} keyshare
    ...
    */
    constructor(keyshare, chain_path, seed) {
        ...
        var ptr2 = isLikeNone(seed) ? 0 : passArray8ToWasm0(seed, wasm.__wbindgen_malloc);
        var len2 = WASM_VECTOR_LEN;
        const ret = wasm.signsessionotvariant_new(ptr0, ptr1, len1, ptr2, len2);
        this.__wbg_ptr = ret >>> 0;
        return this;
    }
    /**
    ...
    */
    toBytes() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.signsessionotvariant_toBytes(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var v1 = getArrayU8FromWasm0(r0, r1).slice();
            wasm.__wbindgen_free(r0, r1 * 1, 1);
    ...
    * Deserialize session from array of bytes.
    * @param {Uint8Array} bytes
    * @returns {SignSessionOTVariant}
    */
    static fromBytes(bytes) {
        const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.signsessionotvariant_fromBytes(ptr0, len0);
        return SignSessionOTVariant.__wrap(ret);
    }
    /**
    * Return an error message, if any.
    * @returns {Error | undefined}
    */
    error() {
        const ret = wasm.signsessionotvariant_error(this.__wbg_ptr);
        return takeObject(ret);
    }
    /**
    * Create a fist message and change session state from Init to WaitMg1.
    ...
    */
    createFirstMessage() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.signsessionotvariant_createFirstMessage(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
    ...
    */
    handleMessages(msgs, seed) {
        try {
            ...
            var ptr1 = isLikeNone(seed) ? 0 : passArray8ToWasm0(seed, wasm.__wbindgen_malloc);
            var len1 = WASM_VECTOR_LEN;
            wasm.signsessionotvariant_handleMessages(retptr, this.__wbg_ptr, ptr0, len0, ptr1, len1);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            var r3 = getInt32Memory0()[retptr / 4 + 3];
    ...
    */
    lastMessage(message_hash) {
        try {
            ...
            const ptr0 = passArray8ToWasm0(message_hash, wasm.__wbindgen_malloc);
            const len0 = WASM_VECTOR_LEN;
            wasm.signsessionotvariant_lastMessage(retptr, this.__wbg_ptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
    ...
    */
    combine(msgs) {
        try {
            ...
            const ptr0 = passArrayJsValueToWasm0(msgs, wasm.__wbindgen_malloc);
            const len0 = WASM_VECTOR_LEN;
            wasm.signsessionotvariant_combine(retptr, ptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
...
module.exports.SignSessionOTVariant = SignSessionOTVariant;
