...
class GenericExtrinsicSignatureV5 extends types_codec_1.Struct {
    ...
    _injectSignature(signer, signature, payload) {
        ...
        for (let i = 0, count = this.__internal__signKeys.length; i < count; i++) {
            ...
            else if (!(0, util_1.isUndefined)(v)) {
                this.set(k, v);
            }
        }
    ...
    addSignature(signer, signature, payload) {
        return this._injectSignature(toAddress(this.registry, signer), this.registry.createTypeUnsafe('ExtrinsicSignature', [signature]), new ExtrinsicPayload_js_1.GenericExtrinsicPayloadV5(this.registry, payload));
    }
    /**
