...
export type DecodedSigningPayload = Omit<TxInfo, 'address' | 'blockNumber' | 'mode'>;
export type DecodedSignedTx = Omit<TxInfo, 'blockHash' | 'blockNumber' | 'genesisHash' | 'metadataHash' | 'mode' | 'specVersion' | 'transactionVersion' | 'version'>;
/**
