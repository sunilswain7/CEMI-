...
__export(faucet_exports, {
  ...
  requestIotaFromFaucetV0: () => requestIotaFromFaucetV0,
  requestIotaFromFaucetV1: () => requestIotaFromFaucetV1
});
...
function getFaucetHost(network) {
  const requestedNetwork = (0, import_client.getNetwork)(network);
