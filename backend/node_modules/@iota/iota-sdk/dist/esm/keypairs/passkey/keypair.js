...
class PasskeyKeypair extends Signer {
   ...
   */
  async sign(data) {
    const allow = this.credentialId ? [this.credentialId] : void 0;
   ...
   */
  static async signAndRecover(provider, message, allowCredentialIds) {
